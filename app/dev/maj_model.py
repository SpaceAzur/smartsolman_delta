...
sys.path.append("/smartsolman/data/dev/SparseMatrixSimilarity/DELTA")
sys.path.append("/smartsolman/data/dev/SparseMatrixSimilarity/DELTA/classes")
from messagedelta import MessageDelta
from normalisation2 import Normalisation2
from modeledelta import Modeledelta
from normalisationdatabase import NormalisationDataBase
...
if __name__ == '__main__':
    ...
    print("\nextraction depuis {}".format(delta.derniere_maj))
